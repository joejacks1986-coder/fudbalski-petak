...
type Props = {
  ...
  lastMatch: { date: string; home_score: number; away_score: number } | null;
};

export default function HomeClient({ matchesCount, playersCount, lastMatch }: Props) {
      ...
      <div className="home-page" style={{ padding: 20, maxWidth: 1200, margin: "0 auto" }}>
        ...
        >
          ...
          <div style={{ padding: 18 }}>
            ...
            >
              Ovo je naš mali fudbalski univerzum: petkom igramo već godinama, a od skoro, zahvaljujući ideji našeg
              Miljana, vodimo evidenciju, beležimo MVP trenutke što kroz statistiku, što kroz "Miljanov ugao" koji se sa
              nestrpljenjem očekuje jutro nakon fudbala (taman kad se svi istreznimo). Projekat postoji iz jednog razloga —
              da se utakmice pamte tačno, pošteno (nema laži, nema prevare), ali i da svi zajedno imamo još jedan razlog
              više da se smejemo i podsećamo proteklih termina.
            </p>
            ...
            <div style={{ display: "flex", gap: 10, marginTop: 14, flexWrap: "wrap" }}>
              <Link
                ...
                style={{
                  ...
                  background: "linear-gradient(180deg, rgba(240,180,41,0.95), rgba(240,180,41,0.78))",
                  fontWeight: 900,
                  color: "#111",
          ...
          >
            <div style={{ border: "1px solid #ddd", borderRadius: 16, padding: 14, background: "white" }}>
              ...
              <div style={{ opacity: 0.9, lineHeight: 1.5 }}>
                Rezultat uvek unosimo ručno (jer rezultat znamo), a strelce/asistente unosimo kad smo sigurni. Statistika
                je u službi istine, ne obrnuto.
              </div>
            </div>
            ...
            <div style={{ border: "1px solid #ddd", borderRadius: 16, padding: 14, background: "white" }}>
              ...
              <div style={{ opacity: 0.9, lineHeight: 1.5 }}>
                Pregled mečeva, međusobni skor, rang liste strelaca/asistenata/MVP — sve na jednom mestu, sa filterima po
                mesecu i godini.
              </div>
            </div>
            ...
            <div style={{ border: "1px solid #ddd", borderRadius: 16, padding: 14, background: "white" }}>
              ...
              <div style={{ opacity: 0.9, lineHeight: 1.5 }}>
                Galerija je za “dokaze”: slike, kratki snimci i momenti zbog kojih se i vraćamo na teren.
              </div>
            </div>
          </div>
        </section>
          ...
          <div style={{ border: "1px solid #ddd", borderRadius: 16, padding: 14, background: "white" }}>
            ...
            >
              <div className="stat-card" style={{ border: "1px solid #eee", borderRadius: 14, padding: 12 }}>
                ...
                <div style={{ fontWeight: 900, fontSize: 22, marginTop: 4 }}>{matchesCount ?? "—"}</div>
              </div>

              <div className="stat-card" style={{ border: "1px solid #eee", borderRadius: 14, padding: 12 }}>
                <div style={{ opacity: 0.7, fontSize: 13 }}>Igrača u bazi</div>
                <div style={{ fontWeight: 900, fontSize: 22, marginTop: 4 }}>{playersCount ?? "—"}</div>
              </div>
